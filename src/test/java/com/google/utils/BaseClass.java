...
public class BaseClass {
	...
	public void screenshot(String name)  {
		try {
			...
			File output = new File("C:\\Users\\Faizu\\Pictures\\Screenshots\\Co.Screenshot\\"+name+".png");
	...
	public void windowQuit(WebElement element)  {
		driver.manage().timeouts().pageLoadTimeout(Duration.ofSeconds(20, 10));
